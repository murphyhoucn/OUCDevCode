...
- ![1](https://gitee.com/murphyhou/picgo/raw/master/image/1.png)
- 根据计算机选择合适的ISO，我选择的是X86_64
- ![2](https://gitee.com/murphyhou/picgo/raw/master/image/2.png)
- 选择镜像
- ![3](https://gitee.com/murphyhou/picgo/raw/master/image/3.png)
- ![4](https://gitee.com/murphyhou/picgo/raw/master/image/4.png)

## 制作安装盘

- 因为电脑之前有系统，是Windows 10专业版，在安装之前首先需要把系统盘格式化；
- 下载U深度软件，将U盘制作成启动盘，将U盘插入需要将要安装成CentOS的电脑中，启动电脑进入BIOS，设置成从U盘启动；
- ![5](https://gitee.com/murphyhou/picgo/raw/master/image/5.png)
- ![6](https://gitee.com/murphyhou/picgo/raw/master/image/6.png)
- 在PE环境中进入硬盘分区工具，把SSD格式化
- ![7](https://gitee.com/murphyhou/picgo/raw/master/image/7.png)
- 再下载软件UltralISO，目的是把之前下载的CentOS提取的U盘（一个已经格式化的U盘）中；
- 在U盘格式化时，注意更改一下命名，因为在之后会再次用的这个名字，这里，我把名字设为LEI；![8](https://gitee.com/murphyhou/picgo/raw/master/image/8.png)
- ![9](https://gitee.com/murphyhou/picgo/raw/master/image/9.png)
- 将CentOS的ISO提取到LEIU盘中
- ![10](https://gitee.com/murphyhou/picgo/raw/master/image/10.jpg)
- ![11](https://gitee.com/murphyhou/picgo/raw/master/image/11.png)
- 提取过程可能有点长
- ![12](https://gitee.com/murphyhou/picgo/raw/master/image/12.png)

## 系统安装

- 提取完成之后，将U盘插入待安装电脑，开机进入BIOS，设置成从UEFI启动盘进入

- ![13](https://gitee.com/murphyhou/picgo/raw/master/image/13.jpg)
- 启动后进入如下界面，需要注意的是不能直接选择两者中的任一个，应该先对第一个进行修改，确定其指定正确的U盘位置！因此根据下面的提示是，先按'e'键
- ![14](https://gitee.com/murphyhou/picgo/raw/master/image/14.jpg)
- 在进入的如下界面，对第二行进行修改，修改成如下（LEI为U盘的名称）
- ![15](https://gitee.com/murphyhou/picgo/raw/master/image/15.jpg)
- ![16](https://gitee.com/murphyhou/picgo/raw/master/image/16.png)
- 这就完成了修改，接下来使用Ctrl+X，退出改界面之后便出现类型如下界面，等待一会儿之后就进入了UI安装界面
- ![17](https://gitee.com/murphyhou/picgo/raw/master/image/17.jpg)
- 进入UI安装界面上，首先设置语言，这里我选择设置为简体中文；设置键盘样式；
- ![18zz](https://gitee.com/murphyhou/picgo/raw/master/image/18zz.jpg)
- 在如下界面中，带有感叹号的都是需要接下来设置的
- ![19](https://gitee.com/murphyhou/picgo/raw/master/image/19.jpg)
- 首先对安装源和安装目的地进行设置：安装目的地设置为之前格式化了的SSD；安装源就是U盘，这里选择最紧的镜像（可能会不一样）
- ![20zz](https://gitee.com/murphyhou/picgo/raw/master/image/20zz.jpg)
- 选择安装的软件：根据需要选择，这里选择的是带GUI的服务器
- ![21](D:/GitHub.io/murphyhou0928.github.io/blogs/2021/Linux.assets/21.jpg)
- 下一步，设置网络时间等
- 在对用户进行设置，我一开始不懂，只创建了用户，没有设置ROOT密码，这个目前无影响，进入系统之后可以再设置
- ![22](https://gitee.com/murphyhou/picgo/raw/master/image/22.jpg)
- 都设置完成后，没有感叹号了，开始安装，进入下一步
- ![23](https://gitee.com/murphyhou/picgo/raw/master/image/23.jpg)
- 之后冒出来这个，不过问题不大/还会有接收许可证的警告，直接接收便可；
- ![24zz](https://gitee.com/murphyhou/picgo/raw/master/image/24zz.jpg)
- 安装！
- ![25](https://gitee.com/murphyhou/picgo/raw/master/image/25.jpg)
- 完成！
- ![26](https://gitee.com/murphyhou/picgo/raw/master/image/26.jpg)
