...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600;\">我是复读机</span></p></body></html>"))
        self.label_4.setText(_translate("Form", "输入发送次数(-1:表示无穷)"))
