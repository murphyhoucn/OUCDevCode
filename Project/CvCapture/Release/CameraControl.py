...
def send_mail():
    ...
    # 设置发送方邮箱密码
    mail_pass="hvtzzpfbtguqdfig" #自助查询-设备管理-自动发送邮件
    # mail_pass="xxx" #自助查询-设备管理-自动发送邮件
    # 设置接受方邮箱
    mail_receiver=['1416790341@qq.com','311989@qq.com']
    ...
    contents=\
        ['CameraControl from yagmail',#邮件正文中写入文字
    ...
    try:
        yag.send(to=mail_receiver,subject="CameraControl from yagmail",contents=contents)
        # print("Send Success!")
